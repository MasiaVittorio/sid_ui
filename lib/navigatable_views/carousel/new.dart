...
//       child: SplashingColoredBackground(_color),
...
//     for(int i = 0; i < n; ++i){
//       final wPadding = (width - fWidth) / 2;
//       final double distance = (i - currentHorizontalValue).toDouble(); 

//       _children.add(Positioned(
//         key: ValueKey("carouselChild$i"),
//         left: wPadding + fWidth * (distance),
//         width: fWidth,
//         height: height,
//         bottom: distance.abs() < 1 
//           ? - currentVerticalValue * verticalDelta * (widget.parallaxEffect ?? 0.3)
//           : 0.0,
...
//       return;
//     _horizontalController.animateTo(i.toDouble(), duration:_flingDuration);
//   }
//   static const _minFlingVelocityHorizontal = 800;
//   static const _flingDuration = Duration(milliseconds: 100);
